...
export interface ApiMainNavigationMainNavigation extends Schema.SingleType {
...
export interface ApiPageSectionPageSection extends Schema.CollectionType {
  ...
  attributes: {
    ...
    page: Attribute.Relation<
      ...
      'api::page.page'
    >;
    blocks: Attribute.DynamicZone<['blocks.default-block']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSocialLinkSocialLink extends Schema.SingleType {
  ...
  attributes: {
    links: Attribute.Component<'components.button', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
